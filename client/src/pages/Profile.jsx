...
export default function Profile() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button onClick={handleShowListings} className="text-green-700 w-full mb-3">Show Listings</button>
      <p className="text-red-700"> {showListingError ? 'Error while showing listings' : ''}</p>
      
           {
            userListings && userListings.length > 0 &&

            <div className=" flex flex-col gap-3">
              <h1 className=" text-slate-600 text-2xl text-center mt-7 font-semibold">Your Listings</h1>
              {
                userListings.map((listing) => (
              <div  key={listing._id} className="flex border rounded-lg p-3 justify-between items-center gap-4 bg-blue-50">
